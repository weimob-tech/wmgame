...
(function (wmGame) {
    ...
    function inite(){
        ...
        scg.inite(wx.createCanvas());
         scg.canvas.realWidth=scg.canvas.width;
         scg.canvas.realHeight=scg.canvas.height;
         var bl=_that2.width/scg.canvas.width;
         scg.canvas.width*=bl;
         scg.canvas.height*=bl;
        ...
        var scg={
            inite:function (id,enba,enbaFW) {
                ...
                requestAnimationFrame=function (fun) {
                 ...
                 wx.onTouchStart(onEventHandle)
                 wx.onTouchMove(onEventHandle)
                 wx.onTouchEnd(onEventHandle)
                 wx.onTouchCancel(onEventHandle)
                 ...
                 scg.remove=function () {
                     wx.offTouchStart(onEventHandle)
                     wx.offTouchMove(onEventHandle)
                     wx.offTouchEnd(onEventHandle)
                     wx.offTouchCancel(onEventHandle)
                 }
            ...
            openRepick:function (opening,noClear) {
                ...
                scg.onFrameHandle=function (){
                     ...
                     if(scg._time==undefined) scg._time=requestAnimationFrame(onFrameHandle);
                ...
                function onFrameHandle() {
                    ...
                    if((t1-t0)<tjg*fps){
                         ...
                         if(scg.opening) scg._time=requestAnimationFrame(onFrameHandle);
            ...
            removeTime:function(){
                 ...
                 if(scg._time!=undefined){
                cancelAnimationFrame(scg._time);
                scg._time=undefined;
            }
